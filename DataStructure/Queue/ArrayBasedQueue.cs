...
public class ArrayBasedQueue<T>
{
      ...
      /// <summary>
      ///   Return a boolean inidicating whether the queue is empty.
      /// </summary>
      public bool IsEmpty() => isEmpty;

      /// <summary>
      ///   Return a boolean inidicating whether the queue is full.
      /// </summary>
      ...
      /// </summary>
      /// <param name="item">{T} to be added in the queue.</param>
